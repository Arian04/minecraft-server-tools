...
server_name="enigmatica-2"	# The name of the server directory
rcon_port="25571"
...
/mnt/minecraft-servers-backup/borg-$server_name-server::$server_name-server-"$(date +"%Y-%m-%d_%H:%M")" 	\
	$mc_dir/servers/${server_name}_server 																																	\
	--exclude $mc_dir/servers/${server_name}_server/backups 2> /tmp/borg-mc-script-error
